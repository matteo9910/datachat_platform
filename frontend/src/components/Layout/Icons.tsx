export const AppIcon = () => (
  <svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 5L33 12.5V27.5L20 35L7 27.5V12.5L20 5Z" fill="#ea580c" />
    <circle cx="20" cy="20" r="6" fill="white" />
    <path d="M20 14V17M20 23V26M14 20H17M23 20H26" stroke="#ea580c" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const Icons = {
  ...
  Settings: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m-9-9h6m6 0h6"/></svg>
  ),
  ChevronLeft: () => (
